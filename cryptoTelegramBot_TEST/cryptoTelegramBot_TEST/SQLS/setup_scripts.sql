...
CREATE TABLE IF NOT EXISTS idex ( marketname text,price decimal(18,9) ,baseVolume decimal(38,9),quoteVolume decimal(38,9),fetchTime int(11) );
...
CREATE TABLE IF NOT EXISTS hitbtc ( marketname text,price decimal(18,9) ,volumeQuote decimal(38,9),volume decimal(38,9),fetchTime int(11) );
...
CREATE TABLE IF NOT EXISTS cryptopia ( marketname text,last_price decimal(18,9) ,baseVolume decimal(38,9),volume decimal(38,9),fetchTime int(11) );
CREATE TABLE IF NOT EXISTS kucoin  ( symbol text,marketname text,price decimal(18,9) ,volValue decimal(38,9),vol decimal(38,9),fetchTime int(11) );
...
CREATE TABLE IF NOT EXISTS  price_denorm_BKP ( rank int(11), id text, symbol text, name text, twitter_screen_name text,tweet_id text,  tweet_fetchTime int , exchange text, marketname text, exchange_last_price decimal(18,9),exchange_last_price_in text, cmc_price_usd decimal(18,9) , cmc_price_btc decimal(18,9), cmc_24h_volume_usd decimal(38,9),cmc_market_cap_usd decimal(38,9),cmc_percent_change_1h decimal(18,9), cmc_percent_change_24h decimal(18,9), cmc_percent_change_7d decimal(18,9),is_new_market text, volume decimal(38,9), created_at int ) ;
...
CREATE TABLE IF NOT EXISTS  price_denorm_t1a ( marketname text, coin text, exchange text,exchange_last_price decimal(18,9),exchange_last_price_in text, volume decimal(38,9)) ;
